...
public class TagCloudView extends ViewGroup{
    ...
    private int getSingleTotalHeight(int totalWidth, int totalHeight) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (i == 0) {
                ...
                totalWidth += mTagBorderHor + childWidth;
            }

            if (child.getTag() != null && (int)child.getTag() == TYPE_TEXT_NORMAL) {
                if (totalWidth + mTagBorderHor + endTextWidth + mViewBorder + imageWidth + mViewBorder < sizeWidth) {
                    child.layout(
                            totalWidth - childWidth,
        ...
        if (endText != null) {
            endText.layout(
                    ...
                    totalWidth + mTagBorderHor + endTextWidth,
                    totalHeight);
        }
    ...
    private int getTextTotalWidth() {
        ...
        return totalChildWidth + mViewBorder * 2;
    }
